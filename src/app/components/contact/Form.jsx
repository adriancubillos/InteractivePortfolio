  ...
  return (
    <>
      ...
      <motion.form
        ...
        initial="hidden"
        animate="show"
        className='max-w-md pt-10 w-full flex flex-col items-center justify-center space-y-4'
        ...
        <motion.input className='px-10 py-4 rounded-md shadow-lg bg-background border border-accent/30 border-solid 
